...
describe "AtomPhpNavigation", ->
  [workspaceElement, activationPromise] = []

  beforeEach ->
    workspaceElement = atom.views.getView(atom.workspace)
    activationPromise = atom.packages.activatePackage('atom-php-navigation')

  describe "when the atom-php-navigation:toggle event is triggered", ->
    it "hides and shows the modal panel", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'atom-php-navigation:toggle'
        expect(atomPhpNavigationPanel.isVisible()).toBe false
    ...
    it "hides and shows the view", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'atom-php-navigation:toggle'
        expect(atomPhpNavigationElement).not.toBeVisible()
